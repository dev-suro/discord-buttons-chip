...
from commands import medianotifications
...
async def on_component(ctx: ComponentContext):
    ...
    if role is not None:
        ...
        if user_role is not None:
            embed = Embed(
                title="Role removed",
                description="The selected role has been removed, please tell an admin.",
                color=Colour.red())
            ...
            embed = Embed(
                title="Role set",
                description="You have been given the selected role",
...
medianotifications.register(slash, guild_id)
